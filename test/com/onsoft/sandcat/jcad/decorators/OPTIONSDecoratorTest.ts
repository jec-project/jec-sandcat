...
import { OPTIONSDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/OPTIONSDecorator";
...
@TestSuite({
  description: "Test the OPTIONSDecorator class methods"
})
export class OPTIONSDecoratorTest {
  ...
  public initTest():void {
    ...
    this.decorator = new OPTIONSDecorator();
  }
  ...
  @Test({
    description: "should create an MethodDescriptor instance initialized with HttpMethod.OPTIONS"
  })
  public httpMethodTest():void {
    ...
    expect(desc.httpMethod).to.equal(HttpMethod.OPTIONS);
  }
