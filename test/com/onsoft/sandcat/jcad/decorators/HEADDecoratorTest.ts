...
@TestSuite({
  description: "Test the HEADDecorator class methods"
})
export class HEADDecoratorTest {
  ...
  public initTest():void {
    ...
    this.decorator = new HEADDecorator();
  }
  ...
  @Test({
    description: "should create an MethodDescriptor instance initialized with HttpMethod.HEAD"
  })
