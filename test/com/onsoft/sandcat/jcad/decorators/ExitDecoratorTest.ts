...
import { ExitDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/ExitDecorator";
...
@TestSuite({
  description: "Test the ExitDecorator class methods"
})
export class ExitDecoratorTest {
  ...
  public initTest():void {
    utils.initRegistry();
    this.decorator = new ExitDecorator();
  }
  ...
  @Test({
    description: "should create a ParameterDescriptor instance initialized with AnnotationType.EXIT"
  })
  public annotationTypeTest():void {
    this.decorator.decorate(utils.TARGET, utils.KEY, utils.PARAMETER_INDEX);
    const desc:ParameterDescriptor = 
                         ParametersMapUtil.getParameterCollection(utils.KEY)[0];
    expect(desc.annotationType).to.equal(AnnotationType.EXIT);
  }
