...
import { TRACEDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/TRACEDecorator";
...
@TestSuite({
  description: "Test the TRACEDecorator class methods"
})
export class TRACEDecoratorTest {
  ...
  public initTest():void {
    ...
    this.decorator = new TRACEDecorator();
  }
  ...
  @Test({
    description: "should create an MethodDescriptor instance initialized with HttpMethod.TRACE"
  })
  public httpMethodTest():void {
    ...
    expect(desc.httpMethod).to.equal(HttpMethod.TRACE);
  }
