...
import { PUTDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/PUTDecorator";
...
@TestSuite({
  description: "Test the PUTDecorator class methods"
})
export class PUTDecoratorTest {
  ...
  public initTest():void {
    ...
    this.decorator = new PUTDecorator();
  }
  ...
  @Test({
    description: "should create an MethodDescriptor instance initialized with HttpMethod.PUT"
  })
  public httpMethodTest():void {
    ...
    expect(desc.httpMethod).to.equal(HttpMethod.PUT);
  }
