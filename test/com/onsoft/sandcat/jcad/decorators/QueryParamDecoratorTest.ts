...
import { QueryParamDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/QueryParamDecorator";
...
@TestSuite({
  description: "Test the QueryParamDecorator class methods"
})
export class QueryParamDecoratorTest {
  ...
  public initTest():void {
    utils.initRegistry();
    this.decorator = new QueryParamDecorator();
  }
  ...
  @Test({
    description: "should create a ParameterDescriptor instance initialized with AnnotationType.QUERY_PARAM"
  })
