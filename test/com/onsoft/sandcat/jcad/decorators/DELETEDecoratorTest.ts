...
import { DELETEDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/DELETEDecorator";
...
@TestSuite({
  description: "Test the DELETEDecorator class methods"
})
export class DELETEDecoratorTest {
  ...
  public initTest():void {
    ...
    this.decorator = new DELETEDecorator();
  }
  ...
  @Test({
    description: "should create an MethodDescriptor instance initialized with HttpMethod.DELETE"
  })
  public httpMethodTest():void {
    ...
    expect(desc.httpMethod).to.equal(HttpMethod.DELETE);
  }
