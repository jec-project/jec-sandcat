...
import { RequestBodyDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/RequestBodyDecorator";
...
@TestSuite({
  description: "Test the RequestBodyDecorator class methods"
})
export class RequestBodyDecoratorTest {
  ...
  public initTest():void {
    utils.initRegistry();
    this.decorator = new RequestBodyDecorator();
  }
  ...
  @Test({
    description: "should create a ParameterDescriptor instance initialized with AnnotationType.REQUEST_BODY"
  })
  public annotationTypeTest():void {
    this.decorator.decorate(utils.TARGET, utils.KEY, utils.PARAMETER_INDEX);
    let desc:ParameterDescriptor = 
                         ParametersMapUtil.getParameterCollection(utils.KEY)[0];
    expect(desc.annotationType).to.equal(AnnotationType.REQUEST_BODY);
  }
