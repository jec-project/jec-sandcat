...
import { CookieParamDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/CookieParamDecorator";
...
@TestSuite({
  description: "Test the CookieParamDecorator class methods"
})
export class CookieParamDecoratorTest {
  ...
  public initTest():void {
    utils.initRegistry();
    this.decorator = new CookieParamDecorator();
  }
  ...
  @Test({
    description: "should create a ParameterDescriptor instance initialized with AnnotationType.COOKIE_PARAM"
  })
  public annotationTypeTest():void {
    this.decorator.decorate(utils.TARGET, utils.KEY, utils.PARAMETER_INDEX);
    let desc:ParameterDescriptor = 
                         ParametersMapUtil.getParameterCollection(utils.KEY)[0];
    expect(desc.annotationType).to.equal(AnnotationType.COOKIE_PARAM);
  }
