...
import { POSTDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/POSTDecorator";
...
@TestSuite({
  description: "Test the POSTDecorator class methods"
})
export class POSTDecoratorTest {
  ...
  public initTest():void {
    ...
    this.decorator = new POSTDecorator();
  }
  ...
  @Test({
    description: "should create an MethodDescriptor instance initialized with HttpMethod.POST"
  })
  public httpMethodTest():void {
    ...
    expect(desc.httpMethod).to.equal(HttpMethod.POST);
  }
