...
import { CONNECTDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/CONNECTDecorator";
...
@TestSuite({
  description: "Test the CONNECTDecorator class methods"
})
export class CONNECTDecoratorTest {
  ...
  @Test({
    description: "should create an MethodDescriptor instance initialized with HttpMethod.CONNECT"
  })
  public httpMethodTest():void {
    ...
    expect(desc.httpMethod).to.equal(HttpMethod.CONNECT);
  }
