...
import { DestroyDecorator } from "../../../../../../src/com/onsoft/sandcat/jcad/decorators/DestroyDecorator";
...
@TestSuite({
  description: "Test the DestroyDecorator class methods"
})
export class DestroyDecoratorTest {
  ...
  public initTest():void {
    ...
    this.decorator = new DestroyDecorator();
  }
