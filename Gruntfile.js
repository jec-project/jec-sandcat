...
/*
 * Provides tasks for building and testing the jec-sandcat project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "jec-sandcat" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-sandcat" API documentation:
