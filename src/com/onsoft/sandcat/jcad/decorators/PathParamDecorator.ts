...
/**
 * The <code>PathParamDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JARS <code>@PathParam</code> decorator.
 */
export class PathParamDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>PathParamDecorator</code> instance.
   */
  constructor() {}
