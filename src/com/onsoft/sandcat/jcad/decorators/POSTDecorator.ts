...
/**
 * The <code>POSTDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JARS <code>@POST</code> decorator.
 */
export class POSTDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>POSTDecorator</code> instance.
   */
  constructor() {}
