...
/**
 * The <code>CONNECTDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JARS <code>@CONNECT</code> decorator.
 */
export class CONNECTDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>CONNECTDecorator</code> instance.
   */
  constructor() {}
