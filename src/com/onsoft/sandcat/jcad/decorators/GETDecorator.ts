...
/**
 * The <code>GETDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JARS <code>@GET</code> decorator.
 */
export class GETDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>GETDecorator</code> instance.
   */
  constructor() {}
