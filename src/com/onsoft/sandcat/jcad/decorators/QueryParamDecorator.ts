...
/**
 * The <code>QueryParamDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JARS <code>@QueryParam</code> decorator.
 */
export class QueryParamDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>QueryParamDecorator</code> instance.
   */
  constructor() {}
  ...
  public decorate(target:any, propertyKey:string | symbol,
    ...
    factory.registerParam(
      propertyKey, parameterIndex, AnnotationType.QUERY_PARAM
    );
    return target;
  }
}
