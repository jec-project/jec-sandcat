...
/**
 * The <code>CookieParamDecorator</code> class defines the 
 * <code>Decorator</code> implementation for the JARS <code>@CookieParam</code>
 * decorator.
 */
export class CookieParamDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>CookieParamDecorator</code> instance.
   */
  constructor() {}
  ...
  public decorate(target:any, propertyKey:string | symbol,
    ...
    factory.registerParam(
      propertyKey, parameterIndex, AnnotationType.COOKIE_PARAM
    );
    return target;
  }
}
