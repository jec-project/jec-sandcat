...
/**
 * The <code>TRACEDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JARS <code>@TRACE</code> decorator.
 */
export class TRACEDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>TRACEDecorator</code> instance.
   */
  constructor() {}
