...
/**
 * The <code>PUTDecorator</code> class defines the <code>Decorator</code>  
 * implementation for the JARS <code>@PUT</code> decorator.
 */
export class PUTDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>PUTDecorator</code> instance.
   */
  constructor() {}
