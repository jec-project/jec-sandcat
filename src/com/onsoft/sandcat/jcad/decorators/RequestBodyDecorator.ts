...
/**
 * The <code>RequestBodyDecorator</code> class defines the 
 * <code>Decorator</code> implementation for the JARS <code>@RequestBody</code>
 * decorator.
 */
export class RequestBodyDecorator implements Decorator {
  ...
  /**
   * Creates a new <code>RequestBodyDecorator</code> instance.
   */
  constructor() {}
  ...
  public decorate(target:any, propertyKey:string | symbol,
    ...
    factory.registerParam(
      propertyKey, parameterIndex, AnnotationType.REQUEST_BODY
    );
    return target;
  }
}
